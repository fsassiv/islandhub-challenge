...
export const CarouselSlide: FC<CarouselSlidePropTypes> = ({ index, data }) => {
  ...
  return (
    <Slide index={index} className="h-full">
      <div className="max-tablet:h-[50vh] rounded-3xl bg-white bg-opacity-60 h-full p-8 flex items-center justify-between flex-wrap font-sans relative desktop:h-[55vh] xl:h-[70vh]">
